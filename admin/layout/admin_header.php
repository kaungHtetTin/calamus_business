...
<nav class="navbar navbar-expand-lg admin-navbar" style="background: white; border-bottom: 1px solid #e8eaed; padding: 12px 24px;">
    <div class="container-fluid">
        <button class="btn btn-sm me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#adminSidebar" aria-controls="adminSidebar" style="border: 1px solid #dadce0;">
            <i style="color: #e8eaed;" class="fas fa-bars"></i>
        </button>
        ...
        <div class="ms-auto d-flex align-items-center">
            <span style="color: #e8eaed;"  class="text-muted me-3">Welcome, <?php echo htmlspecialchars($adminAuth->getAdminUsername()); ?></span>
            <button style="color: #e8eaed;"  class="btn btn-sm btn-outline-secondary" onclick="window.location.href='logout.php'">
                <i style="color: #e8eaed;"  class="fas fa-sign-out-alt me-2"></i>Logout
            </button>
        </div>
    </div>
</nav>
