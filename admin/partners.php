...
<body>
    ...
    <!-- Bootstrap Offcanvas for Navigation -->
                ...
                <nav>
                    <ul class="pagination mb-0">
                        ...
                        <li class="page-item <?php echo $currentPageNum <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="partners.php?page=<?php echo $currentPageNum - 1; ?>">Previous</a>
                        </li>
                        ...
                        if ($startPage > 1): ?>
                            <li class="page-item">
                                <a class="page-link" href="partners.php?page=1">1</a>
                            </li>
                            <?php if ($startPage > 2): ?>
                        ...
                        <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                            <li class="page-item <?php echo $i == $currentPageNum ? 'active' : ''; ?>">
                                <a class="page-link" href="partners.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <?php if ($endPage < $totalPages): ?>
                            ...
                            <?php endif; ?>
                            <li class="page-item">
                                <a class="page-link" href="partners.php?page=<?php echo $totalPages; ?>"><?php echo $totalPages; ?></a>
                            </li>
                        <?php endif; ?>
                        
                        <!-- Next Button -->
                        <li class="page-item <?php echo $currentPageNum >= $totalPages ? 'disabled' : ''; ?>">
                            <a class="page-link" href="partners.php?page=<?php echo $currentPageNum + 1; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
