    ...
    <section class="myanmar-section">
        <div class="container">
            ...
            <div class="feature-card">
                ...
                <p>
                    Calamus Education ရဲ့ Affiliate Program ဆိုတာ ကျောင်းသားတွေကို ဘာသာစကား သင်ယူဖို့ 
                    ...
                    Social Media Platform များပေါ်ရှိ သင်၏ကိုယ်ပိုင် Channel, Page, Account များတွင် ပြန်လည်ကြော်ငြာပေးခြင်းဖြင့် 
            ...
            <div class="feature-card">
                ...
                <p>
                    Calamus Education ၏အရည်အသွေးမြင့် သင်တန်းများကို ပြန်လည်ကြော်ငြာ ပေးရမည်ဖြစ်ပါသည်။ လက်ရှိအချိန်တွင် Calamus Education
                    တွင် English နှင့် Korean ဘာသာစကားသင်တန်းများကို ဖွင့်လှစ်ထားရှိပါသည်။ သင်တန်းများနှင့် သင်ကြားရေး platform များ 
            ...
            <div class="feature-card">
                ...
                <h4>(လျှောက်ထားလိုပါက)လုပ်ငန်းအစီအစဉ်</h4>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        <strong> Step 4</strong>: သင်ထံသို့ သင်တန်းတက်ရောက်ရန် ဆက်သွယ်မေးမြန်းလာသူများအား သင်၏ ကိုယ်ပိုင် unique partner code နှင့် အတူ
                    ...
                    <li>
                        ...
                        သင်တန်းကြေးပေးပြီးပြီးပါက သင်သည် commission (၁၀) ရာခိုင်နှုန်း ရရှိနိုင်မည်ဖြစ်ပါသည်။ သင်တန်းမတက်ရောက်ဖြစ်သော 
            ...
            <div class="feature-card">
                ...
                <h4>ဘယ်လိုအကျိုးကျေးဇူးရရှိနိုင်မလဲ</h4>
                ...
                <ul>
                    ...
                    <li>
                        <strong>သင်တန်းတက်ရောက်လိုသူများ</strong> သင်၏ unique partner code ဖြင့် လာရောက် သင်တန်း အပ်နံသူများသည်
        ...
        <div class="container">
            ...
            <div class="terms-card">
                ...
                <div class="terms-content">
                    <h4>၁။ အကျဉ်းချုပ်</h4>
                    <p>
                        ဤပရိုဂရမ်သည် ကိုယ်စားလှယ်များအား Calamus Education product များကို ၎င်းတို့၏ သီးသန့် unique partner code များ အသုံးပြု၍ ကြော်ငြာရောင်းချခွင့်ပြုပေးမည်ဖြစ်သည်။ ကိုယ်စားလှယ်၏ code ကို အသုံးပြု၍ ဝယ်ယူသော သုံးစွဲသူများသည် ဒစ်စကောင့် ရရှိမည်ဖြစ်ပြီး၊ ကိုယ်စားလှယ်သည် အတည်ပြုပြီးသော ရောင်းချမှုတစ်ခုစီအတွက် ကော်မရှင် (အကျိုးဆောင်ခ) ရရှိမည်ဖြစ်သည်။
                    </p>
                    <p>
                        ဤပရိုဂရမ်တွင် ပါဝင်သည့် ကိုယ်စားလှယ်နှင့်သုံးစွဲသူအားလုံးတို့သည် ဤစည်းကမ်းသတ်မှတ်ချက်များကို သဘောတူသည်ဟု သတ်မှတ်သည်။
                    </p>
                    ...
                    <ul>
                        ...
                        <li>အတည်ပြုပြီးသော ကိုယ်စားလှယ်တစ်ဦးစီသည် ကုမ္ပဏီမှ ထုတ်ပေးမည့် သီးသန့် unique partner code တစ်ခု ရရှိမည်ဖြစ်သည်။</li>
                    ...
                    <ul>
                        <li>ကိုယ်စားလှယ်များသည် ၎င်းတို့၏ code ကို အသုံးပြု၍ သင်တန်းတက်ရောက်သော သင်တန်းကြေးတိုင်းအတွက် ၁၀% ကော်မရှင် ရရှိမည်ဖြစ်သည်။</li>
                        <li>သင်တန်းတက်ခြင်းကို အတည်ပြုပြီးနောက်၊ သုံးစွဲသူမှ ငွေပြန်အမ်းခိုင်းခြင်း သို့မဟုတ် ပယ်ဖျက်ခြင်း မပြုလုပ်မှသာ ကော်မရှင်ကို တွက်ချက်မည်ဖြစ်သည်။</li>
                        ...
                        <li>အနည်းဆုံး ငွေထုတ်ပမာဏမှာ ၁၀,၀၀၀(တစ်သောင်း) ကျပ် ဖြစ်သည်။ ဤပမာဏထက် နည်းသော လက်ကျန်ငွေများကို နောက်လသို့ပေါင်းထည့်၍ သတ်မှတ်ငွေထုတ်ပမာဏပြည့်မှထုတ်ပေးသွားမည်ဖြစ်သည်။</li>
                        <li>ကုမ္ပဏီသည် ကြိုတင်အကြောင်းကြားခြင်းဖြင့် ကော်မရှင်နှုန်းထားများကို အချိန်မရွေး ချိန်ညှိခွင့်ရှိသည်။</li>
                    </ul>

                    <h4>၄။ သင်တန်းတက်ရောက်မည့်သူများအတွက် လျှော့စျေး</h4>
                    <ul>
                        <li>သင်တန်းကြေးသွင်းရာတွင် တရားဝင် unique partner code ကို အသုံးပြုသောသူများသည် ၁၀% လျှော့စျေး ရရှိမည်ဖြစ်သည်။</li>
                        <li>လျှော့စျေးသည် ဝယ်ယူသည့်အချိန်တွင် code ထည့်သွင်းမှသာ အကျုံးဝင်မည်။</li>
                        <li>သင်တန်းတက်ရောက်သူသည် Referral code ကို တစ်ခေါက်သာ အသုံးပြုနိုင်မည် ဖြစ်သည်။</li>
                    </ul>
                    ...
                    <p>ကုမ္ပဏီသည် အတည်မပြုရသေးသော သို့မဟုတ် သံသယဖြစ်ဖွယ် ငွေလွှဲမှုများအတွက် ကော်မရှင်ပေးချေမှုများကို ရပ်ဆိုင်းထားခြင်း သို့မဟုတ် ငြင်းပယ်ပိုင်ခွင့်ရှိသည်။</p>

                    <div class="highlight-box">
                        <h4>၆။ လိမ်လည်မှု နှင့် အလွဲသုံးစားပြုမှု</h4>
                        <p>မလျော်မကန်သောအပြုအမူများ ပြုလုပ်ရန် ကြိုးပမ်းမှု သို့မဟုတ် စနစ်အား လှည့်ဖြားခြင်းများ ပြုလုပ်ပါက အောက်ပါနည်းလမ်းများအတိုင်းဆောင်ရွက်မည်-</p>
                        <ul>
                            <li>ပရိုဂရမ်မှ ချက်ချင်း ဆိုင်းငံ့ခြင်း သို့မဟုတ် ရပ်စဲခြင်း။</li>
                            <li>မရရှိသေးသော ကော်မရှင်များအားလုံးကို ဆုံးရှုံးခြင်း။</li>
                        </ul>
                        <p>ကိုယ်စားလှယ်များသည် ၎င်းတို့၏ unique partner code ကို ကြော်ငြာရန်အတွက် မှားယွင်းသော၊ လှည့်ဖြားသော၊ တရားဉပဒေနှင့်မလွတ်ကင်းသော ကြော်ငြာများ၊ သို့မဟုတ် ကိုယ်ကျင့်တရားနှင့် မညီသော နည်းလမ်းများကို အသုံးမပြုရ။</p>
                    ...
                    <ul>
                        <li>၃ လကြာသည်အထိ အတည်ပြုပြီး ရောင်းချမှု မရှိသော ကိုယ်စားလှယ်များကို Active မဖြစ်ဟု သတ်မှတ်နိုင်သည်။</li>
                    ...
                    <ul>
                        ...
                        <li>ပရိုဂရမ် ရပ်စဲပါက၊ အတည်ပြုပြီးသော ကော်မရှင်များကို ပုံမှန်လုပ်ထုံးလုပ်နည်းများအတိုင်း ဆက်လက်ပေးချေသွားမည်။</li>
                    </ul>
